...
public class FileUtils {
     ...
     * 获取视频文件的一帧
     */
    public static Bitmap getVideoFrame(Context context,String path, int wDp, int hDp) {
        MediaMetadataRetriever media = new MediaMetadataRetriever();
        media.setDataSource(path);
        return BitmapUtil.zoomImage(media.getFrameAtTime(), DimensUtils.dip2px(context, wDp), DimensUtils.dip2px(context, hDp));
    }

    /**
     * 获取照片选择的文件路径
     */
    public static String getFileSelectPath(Context context,Intent data) {
    ...
    public static String startPaiZhao(Activity context, int requestCode,String path) {

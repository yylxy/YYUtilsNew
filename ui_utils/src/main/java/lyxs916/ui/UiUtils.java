...
public class UiUtils {
    ...
    public static void setColorSchemeResources(SwipeRefreshLayout swipeRefreshLayout) {
        swipeRefreshLayout.setColorSchemeResources(R.color.blue, R.color.green, R.color.red, R.color.orange);
    }
...
//        }
    ...
    private static void exitOrShowInput(Context context,IBinder iBinder, View view) {

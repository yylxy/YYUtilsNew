...
//    }
     ...
     */
    public static StateListDrawable getStateListDrawable(Context context,int idNormal, int idPressed, int isEnabledId) {
        StateListDrawable bg = new StateListDrawable();
        Drawable normal = idNormal == -1 ? null : context.getResources().getDrawable(idNormal);
        Drawable pressed = idPressed == -1 ? null :context.getResources().getDrawable(idPressed);
        Drawable enabled = isEnabledId == -1 ? null : context.getResources().getDrawable(isEnabledId);
     ...
     * 获取StateListDrawable实例
     */
    public static StateListDrawable getStateSelectDrawable(Context context, @DrawableRes int selectRes, @DrawableRes int defaultRes) {
        StateListDrawable bg = new StateListDrawable();
        Drawable normal = defaultRes == -1 ? null : context.getResources().getDrawable(defaultRes);
        Drawable select = selectRes == -1 ? null : context.getResources().getDrawable(selectRes);
